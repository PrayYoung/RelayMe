...
class McpAdapterTests(unittest.TestCase):
    ...
    def test_exposes_exactly_the_read_only_r0_tools_without_a_server_prefix(self):
        self.assertEqual(set(server.TOOL_NAMES), {"list_hosts", "list_host_resources", "host_status", "process_list", "read_logs", "read_file", "git_diff"})
